...
Room.prototype._signalSend = function(message) {
    print('r:o:'+JSON.stringify(message));
        ...
        self.peers[o.From].c.setRemoteDescription(new RTCSessionDescription(o.Data), function() {
            ...
            self.peers[o.From].c.createAnswer(function(asd) {
                self.peers[o.From].c.setLocalDescription(asd, function() {
                    ...
                    print('r:e:on got offer, set local dsp error');
                });
            }, function(e) {
                print('r:e:on got offer, create answer error');
            });
        }, function(e){
            print('r:e:on got offer, set remote dsp error');
        });
        break;
    case 'answer':
        var self = this;
        self.peers[o.From].c.setRemoteDescription(new RTCSessionDescription(o.Data), function(){
            ...
            print('r:e:on got answer, set remote dsp error');
        });
        break;
    case 'notice':
        if(typeof this.handles["message_notice"] === 'function'){
            print('r:e:message_notice');
...
Room.prototype._join_older = function(o) {
    ...
    c.createOffer(function(osd) {
        c.setLocalDescription(osd, function() {
            ...
            print('r:error:'+o.Data+':set local dsp error on create offer');
        });
    }, function(e){
        print('r:error:'+o.Data+':create offer error');
    });
    c.oniceconnectionstatechange = function(e) {
        print('r:ics:offer:'+o.Data +':'+c.iceConnectionState);
        if (c.iceConnectionState === 'connected') {
            if(typeof self.handles["peer_open"] === 'function'){
                print('r:e:'+o.Data+':peer_open');
    ...
    c.onsignalingstatechange = function(e) {
        print('r:ss:offer:'+o.Data+':' + c.signalingState);
    }
}
...
Room.prototype._join_newer = function(o) {
    ...
    c.oniceconnectionstatechange = function(e) {
        print('r:ics:anwser:'+o.Data+':' + c.iceConnectionState);
        if (c.iceConnectionState === 'connected') {
            if(typeof self.handles["peer_open"] === 'function'){
                print('r:e:'+o.Data+':peer_open');
                self.handles["peer_open"](o.Data, e);
    ...
    c.onsignalingstatechange = function(e) {
        print('r:ss:anwser:'+o.Data+':' + c.signalingState);
    }
